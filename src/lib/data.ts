export type Pot = { id: string; name: string; price: number; color: string; shape: "round" | "tall" | "square" | "bowl" };
export type Plant = { id: string; name: string; price: number; color: string; leafShape: "broad" | "narrow" | "round" | "spike" };
...
export const OCCASIONS = ["Birthday", "Wedding", "Farewell", "Anniversary", "Housewarming", "Thank You", "Just Because"];
...
export const SAMPLE_GUESTS: Guest[] = [
  { id: "g1", firstName: "Ananya", lastName: "Sharma", email: "ananya@example.com", phone: "+91 98200 11111", city: "Mumbai",     street: "12 Pali Hill",    pin: "400050", rsvp: "attending", invite: "viewed", delivery: "delivered", lat: 19.07, lng: 72.84 },
  { id: "g2", firstName: "Rajan",  lastName: "Mehta",  email: "rajan@example.com",  phone: "+91 98200 22222", city: "Delhi",      street: "5 Hauz Khas",     pin: "110016", rsvp: "pending",   invite: "sent",   delivery: "transit",   lat: 28.55, lng: 77.20 },
  { id: "g3", firstName: "Meera",  lastName: "Iyer",   email: "meera@example.com",  phone: "+91 98200 33333", city: "Bangalore",  street: "44 Indiranagar",  pin: "560038", rsvp: "attending", invite: "viewed", delivery: "delivered", lat: 12.97, lng: 77.64 },
  { id: "g4", firstName: "Karan",  lastName: "Patel",  email: "karan@example.com",  phone: "+91 98200 44444", city: "Ahmedabad",  street: "9 Bodakdev",      pin: "380054", rsvp: "declined",  invite: "viewed", delivery: "delivered", lat: 23.03, lng: 72.51 },
  { id: "g5", firstName: "Priya",  lastName: "Nair",   email: "priya@example.com",  phone: "+91 98200 55555", city: "Chennai",    street: "21 Adyar",        pin: "600020", rsvp: "pending",   invite: "sent",   delivery: "transit",   lat: 13.00, lng: 80.25 },
  { id: "g6", firstName: "Vikram", lastName: "Singh",  email: "vikram@example.com", phone: "+91 98200 66666", city: "Pune",       street: "7 Koregaon Park", pin: "411001", rsvp: "attending", invite: "viewed", delivery: "delivered", lat: 18.54, lng: 73.89 },
  { id: "g7", firstName: "Neha",   lastName: "Kapoor", email: "neha@example.com",   phone: "+91 98200 77777", city: "Hyderabad",  street: "33 Banjara Hills",pin: "500034", rsvp: "pending",   invite: "not-sent",delivery: "not-sent",  lat: 17.41, lng: 78.45 },
  { id: "g8", firstName: "Arjun",  lastName: "Reddy",  email: "arjun@example.com",  phone: "+91 98200 88888", city: "Kolkata",    street: "11 Park Street",  pin: "700016", rsvp: "declined",  invite: "viewed", delivery: "failed",    lat: 22.55, lng: 88.36 },
];
